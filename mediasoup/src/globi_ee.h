 ...
 */
void ee_on                             ( ee_t* self, const char* name, const ee_cb cb, void* const eArg);

/*
 * Synonym for `on`
 */
void ee_add_listener                   ( ee_t* self, const char* name, const ee_cb cb, void* const eArg);

/*
 * Same as `on`, except that the even listener will be automatically removed after the event was emitted once.
 */
void ee_once                           ( ee_t* self, const char* name, const ee_cb cb, void* const eArg);
