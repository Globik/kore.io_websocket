...
//{
		//if (optarg == nullptr)	MS_THROW_ERROR("unknown configuration parameter: %s", optarg);
		...
		//	case 'l':
			...
			//case 't':
			std::string	stringValue_5 = std::string("info");
				logTags.push_back(stringValue_5);
			//	break;

		//	case '4':
				std::string stringValue_4 = std::string("127.0.0.1");//std::string(optarg);
				SetRtcIPv4(stringValue_4);
			//	break;
/*
			case '6':
...
/*
		...
		//case '7':
				stringValue                              = std::string("false");//std::string(optarg);
		...
		//	case 'c':
				std::string stringValue_2                                 = std::string("fucker.js");//std::string(optarg);
				Settings::configuration.dtlsCertificateFile = stringValue_2;
			//	break;

			//case 'p':
				std::string stringValue_3                               = std::string("what_a_shit.c");//std::string(optarg);
				Settings::configuration.dtlsPrivateKeyFile = stringValue_3;
				//break;
/*
			// Invalid option.
			case '?':
