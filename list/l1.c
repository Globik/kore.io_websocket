...
void ee_on(ee_t* self, const char* name, const ee_cb handler, void* eArg) {
  ee__on(self, name, 0, handler, eArg);
}

void ee_add_listener(ee_t* self, const char* name, const ee_cb handler, void* eArg) {
  ee_on(self, name, handler, eArg);
}

void ee_once(ee_t* self, const char* name, const ee_cb handler, void* eArg) {
