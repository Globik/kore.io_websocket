 ...
 */
int janus_process_incoming_request(/* janus_request *request */struct connection*,json_t*);
 ...
 * @returns 0 on success, a negative integer otherwise
 */
int janus_process_incoming_admin_request(/*janus_request *request */ struct connection*, json_t*);
 ...
 * @returns 0 on success, a negative integer otherwise
 */
int janus_process_success(/*janus_request *request */ struct connection*request, json_t *payload);
